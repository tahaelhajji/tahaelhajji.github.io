...
In my current research work, I focus on regional electric aircraft. I work on the design and optimization of Surface PMSM to achieve industrial specifications for regional aircrafts. A benchmark of different machines is performed targeting a high specific power. The gearbox's mass is also included to evaluate the overall performances. You can read <a href="https://yle.fi/a/3-12302109" target="_blank">here</a> about the utility of regional electric aircrafts in Nordic countries.  
